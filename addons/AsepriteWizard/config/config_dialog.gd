...
func _ready():
	...
	_importer_enable_field.button_pressed = _config.is_importer_enabled()
	_remove_source_files_field.button_pressed = _config.should_remove_source_files()
	_enable_animation_loop.button_pressed = _config.is_default_animation_loop_enabled()
...
func _on_save_button_up():
	_config.set_meta_pressed(_aseprite_command_field.text)
